...
CREATE TABLE `test` (
    ...
    CONSTRAINT `fk_test` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
)ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
-- ----------------------------
-- Table structure for select_problem
-- ----------------------------
DROP TABLE IF EXISTS `select_problem`;
CREATE TABLE `select_problem` (
    `tid` int(11) NOT NULL,
    `pid` int(11) NOT NULL,
    PRIMARY KEY (`tid`, `pid`) USING BTREE
...
CREATE TABLE `problem` (
    ...
    `ans` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
    PRIMARY KEY (`pid`) USING BTREE,
    CONSTRAINT `fk1_problem` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
)ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
-- ----------------------------
...
-- ----------------------------
-- Table structure for test_attend
-- ----------------------------
DROP TABLE IF EXISTS `test_attend`;
CREATE TABLE `test_attend`  (
    `tid` int(11) NOT NULL,
    `user_id` int(11) NOT NULL,
    `get_score` int(11) NOT NULL,
    PRIMARY KEY (`tid`, `user_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
-- ----------------------------
...
CREATE TABLE `student_answer`  (
    ...
    PRIMARY KEY (`pid`, `user_id`,`tid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
-- ----------------------------
-- Records of course
-- ----------------------------
...
INSERT INTO `problem` VALUES (1,1,4,'sb','we','A');
